    ...
    <div className='relative z-50'>
      ...
      </form>
      {
        checkEqualName(searchTerm).length > 0 && (
          <div className='autocomplete-square w-full flex bottom-0 h-0 flex-col absolute justify-items-center items-center translate-y-2'>
            <div className='autocomplete-triangle w-0 h-0 bottom-0 border-x-transparent border-x-8 border-b-[8px] border-gray-700 -translate-y-1/2'></div>
